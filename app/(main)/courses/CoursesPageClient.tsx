  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      {[...Array(20)].map((_, i) => (
        <div
          key={i}
          className="absolute h-px w-px rounded-full bg-gradient-to-r from-blue-500/20 to-lime-500/20"
          style={{
...
export default function CoursesPageClient() {
  ...
  return (
    <div 
      className="min-h-screen bg-gray-950 text-gray-100 overflow-hidden"
      style={{
        background: `radial-gradient(ellipse at ${mousePosition.x}px ${mousePosition.y}px, rgba(30, 58, 138, 0.15) 0%, rgba(15, 23, 42, 0.95) 50%, rgba(0, 0, 0, 1) 100%)`,
      }}
    >
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          <div className="grid gap-16 lg:grid-cols-2 lg:gap-20">
            <div className="flex flex-col justify-center">
              <div className="mb-8 inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-blue-500/20 to-lime-500/20 px-6 py-3 text-sm font-medium text-blue-300 backdrop-blur-sm border border-blue-500/30">
                <Sparkles className="h-4 w-4" />
                <span>Elite Personalized Training</span>
              </div>
              ...
              <p className="mb-10 text-xl text-gray-300 leading-relaxed">
                <span className="font-semibold text-blue-300">Exclusive 1-on-1 live sessions</span> crafted around your career ambitions. 
                Transform your professional capabilities through{' '}
                <span className="font-semibold text-lime-300">hands-on, practical mastery</span> designed for 
                ambitious professionals and career accelerators.{' '}
                <span className="font-semibold text-blue-300">Achieve measurable ROI</span> from day one.
              </p>
              
              <div className="flex flex-col gap-6 sm:flex-row">
                <Link
                  href="https://courses.gemsalex.com"
                  className="group relative overflow-hidden rounded-xl bg-gradient-to-r from-blue-600 to-blue-700 px-10 py-4 text-center font-semibold text-white transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/25"
                  aria-label="Explore elite training programs and courses"
                >
                  <span className="relative z-10">Explore Premium Courses</span>
            ...
            <div className="relative">
              <div className="relative overflow-hidden rounded-3xl border border-blue-500/30 bg-gradient-to-br from-gray-900 to-gray-950 p-1 shadow-2xl">
                <div className="relative aspect-square overflow-hidden rounded-2xl bg-gradient-to-br from-blue-500/20 via-transparent to-lime-500/20">
                  <div className="absolute inset-0 flex flex-col items-center justify-center p-8">
                    ...
                    <p className="mb-2 text-2xl font-bold text-white">Executive Live Sessions</p>
                    <p className="text-blue-200">Real-time mastery with industry authority</p>
                  </div>
                  
                  {/* Animated gradient border */}
                  <div className="absolute inset-0 rounded-2xl border-2 border-transparent bg-gradient-to-r from-blue-500/20 via-lime-500/20 to-blue-500/20 bg-[length:200%_100%] animate-gradient-shift" />
                </div>
              </div>
              ...
              <div className="mt-10 grid grid-cols-2 gap-6">
                {[
                  { value: '100%', label: 'Flexible Scheduling', icon: Calendar },
                  { value: '1:1', label: 'Personalized Coaching', icon: Users },
                  { value: '0%', label: 'Time Wasted', icon: Clock },
                  { value: '↑87%', label: 'Career Impact', icon: TrendingUp }
                ].map((stat, index) => (
                  <div 
                    key={index}
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="mb-16 text-center">
            <div className="inline-flex items-center gap-3 rounded-full bg-gradient-to-r from-blue-500/10 to-lime-500/10 px-6 py-2">
              ...
              <span className="text-sm font-medium text-lime-300">Why Elite Professionals Choose Us</span>
            </div>
            ...
            <p className="mx-auto mt-4 max-w-2xl text-gray-400">
              Designed for individuals who demand excellence and measurable career acceleration
            </p>
          </div>
            ...
            {[
              {
                ...
                description: 'Every session aligns with your long-term career trajectory and professional growth objectives',
                gradient: 'from-blue-500/20 to-blue-600/20'
              },
              {
                icon: Clock,
                title: 'Executive Time Optimization',
                description: 'Schedule sessions around your peak productivity hours. No rigid timetables, only optimized learning',
                gradient: 'from-lime-500/20 to-lime-600/20'
              },
              {
                icon: Award,
                title: 'Immediate Value Realization',
                description: 'Apply advanced techniques directly to your work environment for instant productivity transformation',
                gradient: 'from-blue-500/20 to-purple-500/20'
              },
              {
                icon: Shield,
                title: 'Industry Insider Access',
                description: 'Gain insights and methodologies only available through direct mentorship with seasoned experts',
                gradient: 'from-lime-500/20 to-emerald-500/20'
              },
              {
                icon: Rocket,
                title: 'Accelerated Skill Acquisition',
                description: 'Cut learning curves by 60% through focused, high-intensity, practical application sessions',
                gradient: 'from-blue-500/20 to-cyan-500/20'
              },
              {
                icon: BarChart3,
                title: 'Measurable ROI Tracking',
                description: 'Quantify your progress and career impact with data-driven metrics and performance analytics',
      ...
      <section className="px-4 py-24 bg-gradient-to-b from-gray-950 to-black">
        <div className="container mx-auto max-w-6xl">
          <div className="mb-16">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-4 text-gray-400">
                  Premium training programs in today&apos;s most valuable professional competencies
                </p>
              </div>
              <div className="hidden rounded-full bg-gradient-to-r from-blue-500/20 to-lime-500/20 px-6 py-3 md:block">
                <span className="text-sm font-medium text-lime-300">Fully Customizable</span>
              </div>
            </div>
          </div>
            ...
            <div className="relative overflow-hidden rounded-3xl border border-blue-500/30 bg-gradient-to-br from-gray-900 to-black p-8">
              ...
              <div className="relative z-10">
                <div className="mb-8 flex items-center gap-4">
                  ...
                  <h3 className="text-2xl font-bold text-white">Technology & Development Elite</h3>
                </div>
                
                <div className="space-y-6">
                  {[
                    { skill: 'Web Development Mastery (Frontend/Backend)', level: 'Advanced' },
                    { skill: 'WordPress Development & Enterprise Solutions', level: 'Expert' },
                    { skill: 'DevOps & Cloud Infrastructure Engineering', level: 'Professional' },
                    { skill: 'VBA Automation & Excel Power Tools', level: 'Advanced' },
                    { skill: 'MS Access Database Architecture', level: 'Expert' },
                    { skill: 'Custom Software Engineering Solutions', level: 'Professional' }
                  ].map((item, index) => (
                    <div key={index} className="flex items-center justify-between rounded-xl border border-gray-800 bg-gray-900/50 p-4 transition-all hover:border-blue-500/50 hover:bg-gray-900">
            ...
            <div className="relative overflow-hidden rounded-3xl border border-lime-500/30 bg-gradient-to-br from-gray-900 to-black p-8">
              ...
              <div className="relative z-10">
                <div className="mb-8 flex items-center gap-4">
                  ...
                  <h3 className="text-2xl font-bold text-white">Business & Productivity Excellence</h3>
                </div>
                
                <div className="space-y-6">
                  {[
                    { skill: 'MS Office Suite Executive Mastery', level: 'Expert' },
                    { skill: 'Project Management & MS Project Leadership', level: 'Professional' },
                    { skill: 'Digital Marketing & SMMA Strategy', level: 'Advanced' },
                    { skill: 'SEO Optimization & Google Ads Mastery', level: 'Expert' },
                    { skill: 'Business Communication Excellence', level: 'Professional' },
                    { skill: 'Microsoft 365 Enterprise Integration', level: 'Advanced' }
                  ].map((item, index) => (
                    <div key={index} className="flex items-center justify-between rounded-xl border border-gray-800 bg-gray-900/50 p-4 transition-all hover:border-lime-500/50 hover:bg-gray-900">
                      <div className="flex items-center gap-3">
          ...
          <div className="mt-12 rounded-2xl bg-gradient-to-r from-blue-500/10 via-transparent to-lime-500/10 border border-gray-800 p-8 text-center backdrop-blur-sm">
            <p className="text-2xl font-semibold text-white">
              <span className="text-blue-400">Every curriculum</span>{' '}
              is meticulously customized to your{' '}
              <span className="text-lime-400">specific career objectives</span>{' '}
      ...
      <section className="px-4 py-20">
        <div className="container mx-auto max-w-6xl">
          <div className="mb-16 text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-gray-400">
              Our elite training methodology serves individuals committed to exponential career growth
            </p>
          </div>
            ...
            {[
              {
                ...
                description: 'Strategic upskilling for leadership advancement and organizational impact',
                gradient: 'from-blue-500 to-blue-600'
              },
              {
                icon: TrendingUp,
                title: 'Senior Managers',
                description: 'Master advanced tools for team optimization and operational excellence',
                gradient: 'from-lime-500 to-lime-600'
              },
              {
                icon: Globe,
                title: 'Enterprise Freelancers',
                description: 'Expand service portfolios and command premium market rates',
                gradient: 'from-blue-500 to-purple-600'
              },
              {
                icon: MessageSquare,
                title: 'Career Accelerators',
                description: 'Rapid skill acquisition for ambitious professional transitions',
              ...
              >
                <div className={`absolute inset-0 bg-gradient-to-br ${item.gradient} opacity-0 transition-opacity group-hover:opacity-10`} />
                <div className="relative z-10">
      ...
      {/* Elite Process */}
      <section id="process" className="px-4 py-24 bg-gradient-to-b from-black to-gray-950">
        <div className="container mx-auto max-w-6xl">
          <div className="mb-16 text-center">
            <div className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-blue-500/20 to-lime-500/20 px-6 py-2">
              ...
              <span className="text-sm font-medium text-lime-300">Elite Training Methodology</span>
            </div>
            <h2 className="mt-6 text-4xl font-bold md:text-5xl">
              Your Path to{' '}
              <span className="bg-gradient-to-r from-blue-300 to-lime-300 bg-clip-text text-transparent">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-gray-400">
              A refined, results-driven process designed for maximum career acceleration
            </p>
          </div>
              ...
              {[
                {
                  ...
                  description: 'Comprehensive analysis of your career objectives, current capabilities, and growth trajectory',
                  icon: Target
                },
                {
                  step: '02',
                  title: 'Custom Blueprint',
                  description: 'Personalized curriculum design aligning with your specific professional development goals',
                  icon: Palette
                },
                {
                  step: '03',
                ...
                },
                {
                  ...
                  description: 'Implementation of advanced skills leading to measurable professional advancement',
                  icon: Award
                }
              ].map((item, index) => (
          ...
          <div className="relative overflow-hidden rounded-3xl border border-blue-500/30 bg-gradient-to-br from-gray-900 to-black p-12 text-center">
            ...
            <div className="relative z-10">
              <div className="mb-8 inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-blue-500/20 to-lime-500/20 px-6 py-2">
                <Star className="h-4 w-4 text-lime-400" />
                <span className="text-sm font-medium text-lime-300">Limited Availability</span>
              </div>
              ...
              <p className="mx-auto mb-12 max-w-2xl text-xl text-gray-300">
                Join elite professionals who have accelerated their careers through our 
                exclusive, personalized training methodology delivering immediate, 
                measurable workplace impact and accelerated career progression.
              </p>
              
              <div className="flex flex-col justify-center gap-6 sm:flex-row">
                <Link
                  href="https://courses.gemsalex.com"
                  className="group relative overflow-hidden rounded-xl bg-gradient-to-r from-blue-600 to-blue-700 px-10 py-4 font-semibold text-white transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/30"
              ...
              <p className="mt-12 text-sm text-gray-400">
                <span className="text-lime-400">✓</span> Exclusive 1-on-1 mentorship{' '}
                <span className="mx-4 text-gray-600">•</span>
                <span className="text-lime-400">✓</span> Flexible executive scheduling{' '}
                <span className="mx-4 text-gray-600">•</span>
                <span className="text-lime-400">✓</span> Corporate training solutions
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="border-t border-gray-800 px-4 py-8 text-center">
        <p className="text-sm text-gray-500">
          <span className="text-blue-400">All elite training</span> conducted via{' '}
          <span className="text-lime-400">Google Meet or Microsoft Teams</span> •{' '}
          <span className="text-blue-400">Executive scheduling flexibility</span> •{' '}
          <span className="text-lime-400">Customized learning architecture</span> •{' '}
          <Link 
            href="https://courses.gemsalex.com" 
            className="font-medium text-blue-400 hover:text-blue-300 transition-colors"
            aria-label="Access elite training curriculum and enrollment"
          >
            Access elite curriculum at courses.gemsalex.com
          </Link>
        </p>
      </div>
    </div>

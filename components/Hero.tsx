...
const Hero = () => {
  ...
  return (
    <section
      ref={containerRef}
      className="relative pb-20 pt-32 md:pt-40 w-full overflow-hidden flex items-center justify-center min-h-screen"
    >
      ...
      <motion.div
        ...
        initial={{ opacity: 0, y: 100, x: -100 }}
        drag
        className="absolute -left-40 w-[28%] max-w-[400px] h-[320px] md:h-[380px] bottom-10 rounded-3xl p-2 hidden lg:block"
      >
        <Image
          src="/dashboard.jpeg"
          alt={
            isFrench
              ? "Développement de tableau de bord business personnalisé"
              : "Custom Business Dashboard Development"
          }
          fill
          className="w-full h-full p-2 bg-black-200 border border-neutral-700 rounded-3xl shadow-2xl object-cover"
          draggable="false"
        />
      </motion.div>
      ...
      <motion.div
        ...
        initial={{ opacity: 0, x: 100, y: 100 }}
        drag
        className="absolute -right-44 w-[28%] max-w-[400px] h-[320px] md:h-[380px] top-24 rounded-3xl p-2 hidden lg:block"
      >
        <Image
          src="/realestate-dark.jpg"
          alt={
            isFrench
              ? "Solutions technologiques immobilières"
      ...
      <motion.div
        style={{ y: yText }}
        className="relative z-10 w-full max-w-[90vw] md:max-w-3xl lg:max-w-5xl px-6 text-center my-20"
      >
        {/* Eyebrow badge */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          ...
          className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-blue-300/10 border border-blue-300/20 mb-8"
        >
          <span className="w-2 h-2 rounded-full bg-lime-400 animate-pulse" />
          <span className="text-sm font-medium text-blue-200 tracking-wider uppercase">
            {isFrench
              ? "Ingénieur Logiciel Stratégique"
        ...
        >
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-200 to-blue-300">
            {isFrench ? "Solutions Logicielles" : "Custom Software Solutions"}
          </span>{" "}
          <br />
          {isFrench ? "Qui" : "That"}{" "}
          <span className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-lime-400">
            {isFrench ? "Stimulent la Croissance" : "Drive Growth"}
          </span>{" "}
          <br />
          <span className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl text-transparent bg-clip-text bg-gradient-to-r from-blue-200 to-blue-300">
            {isFrench ? "Maximisent le ROI" : "Maximize ROI"}
          </span>
        </motion.h1>
        ...
        <motion.p
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8, ease: "easeOut", delay: 0.4 }}
          className="text-base md:text-lg lg:text-xl text-neutral-400 max-w-3xl mx-auto mb-10 leading-relaxed"
        >
          {isFrench ? (
            <>
              Je suis{" "}
              ...
              , un ingénieur logiciel stratégique qui transforme des défis
              business complexes en applications évolutives et génératrices de
              revenus. Je suis spécialisé dans la création de solutions sur
              mesure qui éliminent les inefficacités opérationnelles et créent
            ...
            <>
              ...
              , a strategic software engineer who transforms complex business
              challenges into scalable, revenue-driving applications. I
              specialize in building custom solutions that eliminate operational
              inefficiencies and create competitive advantages.
            </>
          )}
        </motion.p>        
        ...
        >
          <Link
            href="#case-studies"
            className="group flex items-center gap-3 px-8 py-4 rounded-full bg-gradient-to-r from-blue-200 to-blue-300 text-white font-semibold hover:shadow-lg hover:shadow-blue-300/25 transition-all duration-300 hover:scale-105"
          >
            {isFrench ? "Témoignages Clients" : "Client Success Stories"}
            <FaArrowRight className="group-hover:translate-x-1 transition-transform" />
          </Link>
          <Link
            href="/contact"
            className="flex items-center gap-3 px-8 py-4 rounded-full border-2 border-white/20 text-white font-semibold hover:bg-white/5 hover:border-white/40 transition-all duration-300 hover:scale-105"
          >
            {isFrench ? "Audit Technique Gratuit" : "Get Free Technical Audit"}
          </Link>
        </motion.div>

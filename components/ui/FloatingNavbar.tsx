  ...
  return (
    <AnimatePresence mode="wait">
      ...
      >
        ...
        {/* remove this btn on mobile */}
        <button className="border text-md font-medium relative border-neutral-200 dark:border-white/[0.2] text-black dark:text-white px-4 py-2 rounded-full hidden md:block lg:block">
          <span className="hover:text-lime-500">Get an appointment</span>

      ...
      <div className="container mx-auto max-w-7xl">
        <div className="mb-16 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-gray-400">
            Our personalized training serves career-focused individuals seeking
            measurable growth and practical skill development
          </p>
        </div>
        ...
        <div className="mt-12 md:mt-16 rounded-2xl md:rounded-3xl bg-gradient-to-r from-gray-900 to-black border border-gray-800 p-6 md:p-12">
          <div className="flex flex-col md:grid md:grid-cols-2 gap-8 md:gap-12">
            {/* Left Content */}
            <div className="order-2 md:order-1">
              <div className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-blue-500/20 to-lime-500/20 px-4 py-1.5 mb-4 md:mb-6">
                <span className="text-xs font-medium text-lime-300">
              ...
              <div className="space-y-4 md:space-y-4">
                <div className="flex items-start gap-3">
                  <div className="rounded-lg bg-gradient-to-r from-blue-500/20 to-lime-500/20 p-2 flex-shrink-0">
                    <span className="text-base md:text-lg">🎯</span>
                  </div>
                  <div>
                    <h4 className="font-medium text-white text-sm md:text-base mb-0.5 md:mb-1">
                      Custom Learning Paths
                    </h4>
                    <p className="text-xs md:text-sm text-gray-400">
                      Training adapts to your current skill level and specific
                      career objectives
                    </p>
                  </div>
                </div>
            ...
            {/* Audience Stats - Moved above on mobile */}
            <div className="order-1 md:order-2">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-6">
                {[
                  ...
                  <div
                    key={index}
                    className="relative overflow-hidden rounded-xl md:rounded-2xl border border-gray-800 bg-gray-900/30 backdrop-blur-sm p-4 md:p-6"
                  >
                    {/* Background Gradient */}
                    ...
                    <div className="relative z-10">
                      ...
                      <p className="text-xs md:text-sm text-gray-400 mb-0.5 md:mb-1 line-clamp-1">
                        {stat.label}
                      </p>
                      <p className="text-base md:text-xl font-bold text-white mb-0.5 md:mb-1">
                        {stat.value}
                      </p>
          ...
          <div className="inline-flex flex-col sm:flex-row items-center justify-center gap-4 rounded-2xl bg-gradient-to-r from-blue-500/10 to-lime-500/10 border border-gray-800 p-6 max-w-4xl mx-auto">
            <div className="text-left">
              ...
              <p className="text-sm text-gray-400">
                Schedule a free consultation to discuss your specific goals and
                ideal learning path
              </p>
            </div>
            <Link

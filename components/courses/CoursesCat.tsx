...
const coursesData: Course[] = [
  ...
  },
  {
    ...
    level: "Expert",
    image:
      "/courses/wordpress-bg.png",
    duration: "6 weeks",
    projects: 3,
    description: "Custom themes, website creation, plugins, and e-commerce solutions",
    longDescription:
    ...
    outcomes: [
      ...
      "Build scalable e-commerce stores",
      "Master WordPress development",
      "Launch your own WordPress business",
      "Build WordPress sites without coding",
      "Create websites 10x faster with WordPress",
    ],
  ...
  },
  {
    ...
    prerequisites: [
      "No prior Access experience needed",
      "Basic computer literacy",
      "Willingness to learn",
      "Desire to become an Access expert",
      "Looking to boost productivity with Access",
      "Anyone who wants to master Access for work or personal use",
    ],
    outcomes: [
      ...
      "Become an Access power user",
      "Build custom Access solutions for clients"
    ],
    icon: <Database className="h-6 w-6" />,
  },
  {
    ...
    subcategory: "Data",
    level: "Beginner",
    image: "/courses/excel-background.jpg",
    duration: "6 weeks",
    projects: 5,
    description: "Master Excel from basic techniques to advanced techniques for data analysis, automation and visualization",
    longDescription: "Become an Excel power user. Learn everything from basic formulas to advanced data analysis, automation with VBA, and creating interactive dashboards.",
    bestFor: [
      "Data analysts",
      "Financial professionals",
      "Business analysts",
      "Students",
      "Anyone looking to boost their Excel skills",
    ],
    whatYouWillLearn: [
      ...
      "Charting & graphing mastery",
    ],
    prerequisites: [
      "No prior Excel experience needed",
      "Basic computer literacy",
      "Willingness to learn",
      "Desire to become an Excel expert",
      "Looking to boost productivity with Excel",
      "Anyone who wants to master Excel for work or personal use",
    ],
    outcomes: [
  ...
  // Business & Productivity Courses
  {
    ...
    level: "Expert",
    image:
      "/courses/microsoft-training-bg.jpg",
    duration: "8 weeks",
    projects: 6,
  ...
  {
    id: "amo-pm",
    title: "AMO Project Management",
    category: "business",
    subcategory: "Management",
    level: "Advanced",
    image:
      "/courses/amo-web-bg.jpg",
    duration: "8 weeks",
    projects: 2,
    description: "Master AMO project management methodologies",
    longDescription:
      "Learn the AMO approach to project management. Understand the principles and practices that drive successful project delivery in complex environments.",
    bestFor: [
      "Team leaders",
      "Project coordinators",
      "Product managers",
  ...
  },
  {
    ...
    level: "Intermediate",
    image:
      "/courses/data-analysis-bg.jpg",
    duration: "9 weeks",
    projects: 5,
    description: "Extract insights from data to drive business decisions",
    longDescription:
      "Learn to analyze data and extract actionable insights. Master tools like Excel, Tableau, and SQL to visualize data, identify trends, and support strategic decision-making.",
    bestFor: [
      "Business analysts",
      "Data scientists",
    ...
    prerequisites: ["Basic computer literacy", "Willingness to learn", "Familiarity with spreadsheets"],
    outcomes: [
      "Data-driven decision making",
  ...
  },
  {
    ...
    level: "Beginner",
    image:
      "/courses/usa-flag-bg.jpg",
    duration: "12 weeks",
    projects: 0,
    description: "English for all levels of professionals",
    longDescription:
      "Master communication in English. Learn professional writing, presentation skills, negotiation tactics, and cross-cultural communication.",
    bestFor: [
    ...
    whatYouWillLearn: [
      ...
      "English for international travel",
      "English for cultural understanding",
      "English for confidence in any situation",
    ],
    prerequisites: [
      "No prior English experience needed",            
      "Basic reading literacy",
      "Willingness to learn",
      "Desire to become an English expert",
      "Looking to boost productivity with English",
      "Anyone who wants to master English for work or personal use",
    ],
    outcomes: [
      ...
      "Ability to communicate effectively in English in any situation",
      ...
      "Ability to teach english to others and share your knowledge",
      "Become an English expert and open up new opportunities in the global market",
    ],
  ...
  },
  {
    ...
    level: "Beginner",
    image:
      "/courses/french-flag-bg.jpg",
    duration: "12 weeks",
    projects: 0,
    description: "French for all levels of professionals",
    longDescription:
      "Master communication in French. Learn professional writing, presentation skills, negotiation tactics, and cross-cultural communication.",
    bestFor: [
      ...
      "Sales teams",
      "Customer-facing roles",
      "Anyone looking to boost their French skills for work or personal use"
    ],
    whatYouWillLearn: [
      ...
      "French for job interviews",
      "French for international travel",
      "French for cultural understanding",
      "French for confidence in any situation",      
    ],
    prerequisites: [
      "No prior French experience needed",
      "Basic reading literacy",
      "Willingness to learn",
      "Desire to become a French expert",
      "Looking to boost productivity with French",
      "Anyone who wants to master French for work or personal use",      
    ],
    outcomes: [
      "Confident communication",
      "Better client relationships",
      "Career opportunities",
      "Professional network",
      "Ability to communicate effectively in French in any situation",
      "Improved job prospects and career advancement",
      "Enhanced cultural understanding and global communication skills",
      "Increased confidence in social and professional settings",
      "Fluently Speak French",
      "Ability to teach French to others and share your knowledge",
      "Become a French expert and open up new opportunities in the global market",
    ],
    icon: <Users className="h-6 w-6" />,
  },
  {

...
const nextConfig = {
  ...
  experimental: {
    optimizeCss: true,
    scrollRestoration: true,
    // REMOVED: optimizePackageImports - Causing issues
    // REMOVED: esmExternals: 'loose' - Can cause SSR issues
  },
  ...
  // REMOVE webpack config temporarily - It's causing the SSR error
  // webpack: (config, { isServer, dev }) => { ... },
...
// Temporarily disable Sentry to test
// export default nextConfig; // ← Use this for testing
